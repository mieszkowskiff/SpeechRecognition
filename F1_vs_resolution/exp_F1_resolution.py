...
def main():
    ...
    save_txt(F1_history, "F1_history.txt")
    save_txt(loss_history, "loss_history.txt")
    save_txt(time_history, "time_history.txt")
    print("Data gathered. Experiment performed succesfully.")
